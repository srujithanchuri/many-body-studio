...
class InteractivePlotsWidget(QWidget):
    ...
    def set_theme(self, is_dark: bool):
        ...
        for lbl in ("lbl_mode", "lbl_mu", "lbl_cache", "lbl_jk", "lbl_mom_title", "lbl_slice_title", "lbl_jperp", "lbl_k", "lbl_device"):
            if hasattr(self, lbl):
                getattr(self, lbl).setStyleSheet(main_lbl_style)

        for lbl in ("lbl_kx", "lbl_ky"):
            if hasattr(self, lbl):
                getattr(self, lbl).setStyleSheet(sub_lbl_style)

        if hasattr(self, "lbl_map_tip"):
            self.lbl_map_tip.setStyleSheet(f"color: {lbl_tip_color}; font-size: 10px; font-style: italic; background: transparent;")
        ...
        if hasattr(self, "cb_experiment"):
            self.cb_experiment.setStyleSheet(combo_base + "QComboBox { font-weight: 600; min-width: 130px; max-width: 155px; }")
        ...
        if hasattr(self, "cb_k"):
            self.cb_k.setStyleSheet(combo_base + "QComboBox { min-width: 95px; max-width: 120px; font-weight: 600; }")
        if hasattr(self, "cb_device"):
            self.cb_device.setStyleSheet(combo_base + "QComboBox { min-width: 105px; max-width: 140px; font-weight: 600; }")
        ...
        """
        if hasattr(self, "spin_kx"):
            self.spin_kx.setStyleSheet(spin_style)
        if hasattr(self, "spin_ky"):
            self.spin_ky.setStyleSheet(spin_style)

        # Action Buttons
        if hasattr(self, "btn_clear_mu"):
            self.btn_clear_mu.setStyleSheet(f"""
                QPushButton {{
                    padding: 1px 2px;
        ...
        for b in ("btn_reset", "btn_copy", "btn_save"):
            if hasattr(self, b):
                getattr(self, b).setStyleSheet(btn_action_style)
        ...
        for s in ("slider_jk", "slider_slice", "slider_jperp"):
            if hasattr(self, s):
                getattr(self, s).setStyleSheet(slider_style)

        # Value & HUD chips
        if hasattr(self, "lbl_jk_val"):
            self.lbl_jk_val.setStyleSheet(f"""
                QLabel {{
        ...
        if hasattr(self, "lbl_slice_val"):
            self.lbl_slice_val.setStyleSheet(f"""
                QLabel {{
        ...
        if hasattr(self, "lbl_jperp_val"):
            self.lbl_jperp_val.setStyleSheet(f"""
                QLabel {{
        ...
        """
        if hasattr(self, "lbl_live_z"):
            self.lbl_live_z.setStyleSheet(chip_z)
        if hasattr(self, "lbl_live_gamma"):
            self.lbl_live_gamma.setStyleSheet(chip_g)
        if hasattr(self, "lbl_live_mass"):
            self.lbl_live_mass.setStyleSheet(chip_m)
        if hasattr(self, "lbl_conductivity_stats"):
            self.lbl_conductivity_stats.setStyleSheet(chip_z)

        # Matplotlib canvas background
        if hasattr(self, "canvas"):
            self.canvas.setStyleSheet(f"background: {'#0b1120' if is_dark else '#ffffff'}; border: none;")

        # Active dialog update
        if hasattr(self, "_foundation_dlg") and self._foundation_dlg and self._foundation_dlg.isVisible():
            self._foundation_dlg.set_theme(is_dark)
    ...
    def _build_ui(self):
        ...
        self.lbl_mode.setStyleSheet("font-weight: 700; color: #1e293b; font-size: 11px;")
        r1_lay.addWidget(self.lbl_mode)
        ...
        self.lbl_mu = QLabel("μ:")
        self.lbl_mu.setStyleSheet("font-weight: 700; color: #1e293b; font-size: 11px;")
        r1_lay.addWidget(self.lbl_mu)
        ...
        self.btn_clear_mu.setFixedSize(18, 22)
        ...
        self.btn_save.setToolTip("Save figure (PNG, PDF, SVG)")
        ...
        self.lbl_jk = QLabel("J_K:")
        self.lbl_jk.setStyleSheet("font-weight: 700; color: #1e293b; font-size: 11px;")
        r2_lay.addWidget(self.lbl_jk)
        ...
        self.lbl_kx = QLabel("kx:")
        self.lbl_kx.setStyleSheet("font-size: 10px; font-weight: 600; color: #475569;")
        ck_lay.addWidget(self.lbl_kx)
        ...
        self.lbl_ky = QLabel("ky:")
        self.lbl_ky.setStyleSheet("font-size: 10px; font-weight: 600; color: #475569;")
        ck_lay.addWidget(self.lbl_ky)
        ...
        self.lbl_jperp = QLabel("J_⊥:")
        self.lbl_jperp.setStyleSheet("font-weight: 700; color: #1e293b; font-size: 11px;")
        susc_lay.addWidget(self.lbl_jperp)
        ...
        self.lbl_k = QLabel("K:")
        self.lbl_k.setStyleSheet("font-weight: 700; color: #1e293b; font-size: 11px;")
        susc_lay.addWidget(self.lbl_k)
        ...
        self.lbl_device.setStyleSheet("font-weight: 700; color: #1e293b; font-size: 11px;")
        cond_lay.addWidget(self.lbl_device)
        ...
        self._orig_canvas_draw = self.canvas.draw
        self._orig_canvas_draw_idle = self.canvas.draw_idle
        self.canvas.draw = self._themed_draw
        self.canvas.draw_idle = self._themed_draw_idle
